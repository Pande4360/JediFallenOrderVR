...
namespace _Game_UI_Map_UI_WorldMapGreeble_Small {
#pragma pack(push, 1)
struct UI_WorldMapGreeble_Small_C : public _Script_RsGameTechRT::RsUiWindow {
    ...
    void SetScale();
    void ExecuteUbergraph_UI_WorldMapGreeble_Small(int32_t EntryPoint);
}; // Size: 0x630
#pragma pack(pop)
}
