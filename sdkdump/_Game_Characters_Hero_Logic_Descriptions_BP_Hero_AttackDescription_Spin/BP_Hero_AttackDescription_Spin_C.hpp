...
namespace _Game_Characters_Hero_Logic_Descriptions_BP_Hero_AttackDescription_Spin {
#pragma pack(push, 1)
struct BP_Hero_AttackDescription_Spin_C : public _Script_SwGame::SwAttackState {
    ...
    void ExecuteUbergraph_BP_Hero_AttackDescription_Spin(int32_t EntryPoint);
}; // Size: 0x270
#pragma pack(pop)
}
