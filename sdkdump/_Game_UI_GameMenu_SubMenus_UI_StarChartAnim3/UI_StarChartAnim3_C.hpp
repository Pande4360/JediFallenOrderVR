...
#pragma pack(push, 1)
struct UI_StarChartAnim3_C : public _Game_UI_GameMenu_SubMenus_UI_SubMenu_Base::UI_SubMenu_Base_C {
    private: char pad_278[0x2d8]; public:
    void* get_UberGraphFrame0();
    _Script_UMG::WidgetAnimation*& get_TacticalGuide();
    _Script_UMG::WidgetAnimation*& get_Databank();
    ...
    _Script_UMG::Image*& get_Image_46();
    _Script_UMG::Image*& get_Image_47();
    ...
    void CustomEvent_0();
    void PlayStarChart3();
    void ExecuteUbergraph_UI_StarChartAnim3(int32_t EntryPoint);
}; // Size: 0x550
#pragma pack(pop)
}
