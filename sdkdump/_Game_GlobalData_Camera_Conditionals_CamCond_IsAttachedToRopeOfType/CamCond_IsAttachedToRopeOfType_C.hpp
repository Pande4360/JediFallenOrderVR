...
namespace _Game_GlobalData_Camera_Conditionals_CamCond_IsAttachedToRopeOfType {
#pragma pack(push, 1)
struct CamCond_IsAttachedToRopeOfType_C : public _Script_SwGame::RsCameraConditional {
