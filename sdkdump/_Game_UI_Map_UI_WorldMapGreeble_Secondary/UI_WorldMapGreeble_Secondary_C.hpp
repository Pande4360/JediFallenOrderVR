...
namespace _Game_UI_Map_UI_WorldMapGreeble_Secondary {
#pragma pack(push, 1)
struct UI_WorldMapGreeble_Secondary_C : public _Script_RsGameTechRT::RsUiWindow {
    ...
    void SetScale();
    void ExecuteUbergraph_UI_WorldMapGreeble_Secondary(int32_t EntryPoint);
}; // Size: 0x638
#pragma pack(pop)
}
