...
#pragma pack(push, 1)
struct UI_ControllerMappingLayout_Xbox_C : public _Script_UMG::UserWidget {
    ...
    _Game_UI_GameMenu_ControlsMenu_UI_ControllerMappingButton::UI_ControllerMappingButton_C*& get_Start_Btn();
    void* get_LayoutButtonArray();
    static _Script_CoreUObject::Class* static_class();
    void Construct0();
    void PreConstruct0(bool IsDesignTime);
    void ExecuteUbergraph_UI_ControllerMappingLayout_Xbox(int32_t EntryPoint);
}; // Size: 0x2b0
#pragma pack(pop)
}
