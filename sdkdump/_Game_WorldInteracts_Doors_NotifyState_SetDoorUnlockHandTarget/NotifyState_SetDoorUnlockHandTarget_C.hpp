...
namespace _Game_WorldInteracts_Doors_NotifyState_SetDoorUnlockHandTarget {
#pragma pack(push, 1)
struct NotifyState_SetDoorUnlockHandTarget_C : public _Script_Engine::AnimNotifyState {
