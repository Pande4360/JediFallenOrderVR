...
namespace _Game_Levels_WorldMap_BP_StateTransition_BP_StateTransition_General_OnThenDisappears {
#pragma pack(push, 1)
struct BP_StateTransition_General_OnThenDisappears_C : public _Game_Levels_WorldMap_BP_StateTransition_BP_StateTransition_Parent::BP_StateTransition_Parent_C {
    ...
    void ExecuteUbergraph_BP_StateTransition_General_OnThenDisappears(int32_t EntryPoint);
}; // Size: 0x3d8
#pragma pack(pop)
}
