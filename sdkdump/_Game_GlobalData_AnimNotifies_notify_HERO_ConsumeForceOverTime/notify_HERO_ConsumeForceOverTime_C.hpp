...
namespace _Game_GlobalData_AnimNotifies_notify_HERO_ConsumeForceOverTime {
#pragma pack(push, 1)
struct notify_HERO_ConsumeForceOverTime_C : public _Script_Engine::AnimNotifyState {
