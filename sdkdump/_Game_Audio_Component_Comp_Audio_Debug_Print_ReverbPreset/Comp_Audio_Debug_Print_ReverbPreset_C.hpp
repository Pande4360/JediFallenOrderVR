...
#pragma pack(push, 1)
struct Comp_Audio_Debug_Print_ReverbPreset_C : public _Script_Engine::ActorComponent {
    private: char pad_170[0x28]; public:
    void* get_UberGraphFrame();
    bool get_Toggle_Reverb__Print();
    void set_Toggle_Reverb__Print(bool value);
    ...
    void EnableTick();
    void ExecuteUbergraph_Comp_Audio_Debug_Print_ReverbPreset(int32_t EntryPoint);
}; // Size: 0x198
#pragma pack(pop)
}
