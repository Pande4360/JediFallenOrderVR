...
namespace _Game_GlobalData_Camera_Behaviors_SetLocationWhenPaused {
#pragma pack(push, 1)
struct SetLocationWhenPaused_C : public _Script_RsGameTechRT::RsCameraBehavior {
    ...
    void ExecuteUbergraph_SetLocationWhenPaused(int32_t EntryPoint);
}; // Size: 0x38
#pragma pack(pop)
}
