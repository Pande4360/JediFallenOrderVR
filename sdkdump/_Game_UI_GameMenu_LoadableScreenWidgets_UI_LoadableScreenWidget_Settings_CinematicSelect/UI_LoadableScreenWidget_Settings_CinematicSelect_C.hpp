...
namespace _Game_UI_GameMenu_LoadableScreenWidgets_UI_LoadableScreenWidget_Settings_CinematicSelect {
#pragma pack(push, 1)
struct UI_LoadableScreenWidget_Settings_CinematicSelect_C : public _Game_UI_GameMenu_LoadableScreenWidgets_UI_LoadableScreenWidget::UI_LoadableScreenWidget_C {
    ...
    _Script_UMG::WrapBox*& get_StartMenuGrid_0();
    ...
    void ReceivedFocus0();
    void LostFocus_1();
    void ExecuteUbergraph_UI_LoadableScreenWidget_Settings_CinematicSelect(int32_t EntryPoint);
}; // Size: 0x2e0
#pragma pack(pop)
}
