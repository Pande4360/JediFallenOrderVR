...
namespace _Game_GlobalData_AnimNotifies_notify_PushPopMotionParm_OLD {
#pragma pack(push, 1)
struct notify_PushPopMotionParm_OLD_C : public _Script_Engine::AnimNotifyState {
    private: char pad_30[0x10]; public:
    void* get_MotionParm();
    bool get_AllowAI_Orientation();
    void set_AllowAI_Orientation(bool value);
