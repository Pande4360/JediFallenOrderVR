...
namespace _Game_Characters_BuddyDroid_01_Logic_AnimNotifies_notify_BD1_AttachInjector {
#pragma pack(push, 1)
struct notify_BD1_AttachInjector_C : public _Script_Engine::AnimNotifyState {
