...
namespace _Game_Levels_WorldMap_BP_StateTransition_BP_StateTransition_Overcharge {
#pragma pack(push, 1)
struct BP_StateTransition_Overcharge_C : public _Game_Levels_WorldMap_BP_StateTransition_BP_StateTransition_Parent::BP_StateTransition_Parent_C {
    private: char pad_3a8[0x30]; public:
    void* get_UberGraphFrame0();
    _Script_RsGameTechRT::RsWorldMapStaticMeshComponent*& get_ControlledAsset();
    _Script_RsGameTechRT::RsWorldMapStaticMeshComponent*& get_OverchargePanel();
    ...
    void ExecuteUbergraph_BP_StateTransition_Overcharge(int32_t EntryPoint);
}; // Size: 0x3d8
#pragma pack(pop)
}
