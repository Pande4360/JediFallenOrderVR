...
namespace _Game_Characters_Croakadile_Logic_BehaviorTree_BTD_CroakNoTongue {
#pragma pack(push, 1)
struct BTD_CroakNoTongue_C : public _Script_AIModule::BTDecorator_BlueprintBase {
