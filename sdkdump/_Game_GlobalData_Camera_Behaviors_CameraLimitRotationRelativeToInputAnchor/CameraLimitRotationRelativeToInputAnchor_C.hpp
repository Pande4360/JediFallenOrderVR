...
namespace _Game_GlobalData_Camera_Behaviors_CameraLimitRotationRelativeToInputAnchor {
#pragma pack(push, 1)
struct CameraLimitRotationRelativeToInputAnchor_C : public _Script_RsGameTechRT::RsCameraBehavior {
    private: char pad_30[0x8]; public:
    float& get_YawAngleLimitHalf();
    float& get_PitchAngleLimitHalf();
