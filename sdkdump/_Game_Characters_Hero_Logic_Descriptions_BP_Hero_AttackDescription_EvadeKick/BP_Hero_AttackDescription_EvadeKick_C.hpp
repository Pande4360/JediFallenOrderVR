...
namespace _Game_Characters_Hero_Logic_Descriptions_BP_Hero_AttackDescription_EvadeKick {
#pragma pack(push, 1)
struct BP_Hero_AttackDescription_EvadeKick_C : public _Script_SwGame::SwAttackState {
    private: char pad_258[0x18]; public:
    void* get_UberGraphFrame();
    _Game_Characters_Hero_Logic_BP_Hero::BP_Hero_C*& get_BP_Hero();
    _Script_RsGameTechRT::RsCharacter*& get_AttackTarget();
    ...
    void ExecuteUbergraph_BP_Hero_AttackDescription_EvadeKick(int32_t EntryPoint);
}; // Size: 0x270
#pragma pack(pop)
}
