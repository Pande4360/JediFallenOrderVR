...
namespace _Game_GlobalData_AnimNotifies_notify_HERO_CameraOffsetDuringRoll {
#pragma pack(push, 1)
struct notify_HERO_CameraOffsetDuringRoll_C : public _Script_Engine::RsConditionalTargetAnimNotifyState {
