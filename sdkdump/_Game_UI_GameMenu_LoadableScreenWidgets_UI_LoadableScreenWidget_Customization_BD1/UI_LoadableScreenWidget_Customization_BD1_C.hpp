...
namespace _Game_UI_GameMenu_LoadableScreenWidgets_UI_LoadableScreenWidget_Customization_BD1 {
#pragma pack(push, 1)
struct UI_LoadableScreenWidget_Customization_BD1_C : public _Game_UI_GameMenu_LoadableScreenWidgets_UI_LoadableScreenWidget_Customization_Base::UI_LoadableScreenWidget_Customization_Base_C {
    ...
    void ReceivedFocus();
    void ExecuteUbergraph_UI_LoadableScreenWidget_Customization_BD1(int32_t EntryPoint);
}; // Size: 0x2f8
#pragma pack(pop)
}
