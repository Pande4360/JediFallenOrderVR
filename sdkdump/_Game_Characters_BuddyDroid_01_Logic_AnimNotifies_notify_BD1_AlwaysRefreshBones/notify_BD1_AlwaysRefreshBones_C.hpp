...
namespace _Game_Characters_BuddyDroid_01_Logic_AnimNotifies_notify_BD1_AlwaysRefreshBones {
#pragma pack(push, 1)
struct notify_BD1_AlwaysRefreshBones_C : public _Script_Engine::AnimNotifyState {
